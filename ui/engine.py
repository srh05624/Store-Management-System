...
class Engine:
    ...
    def create_rectangle(cls, size=(100, 100), position=(0, 0), color=(255, 255, 255, 255), border_color=(0, 0, 0, 255), border_width=1, border_radius=5, window=None):
        try:
            rectangle = QtWidgets.QLabel(window)
    ...
    def create_list_item(cls, parent):
        try:
            return QtWidgets.QListWidgetItem(parent)
        except Exception as e:
    ...
    def create_checkbox(
        ...
        try:
            checkbox = QtWidgets.QCheckBox(text, window)
    ...
    def create_button(
        ...
        try:
            button = QtWidgets.QPushButton(text, window)
